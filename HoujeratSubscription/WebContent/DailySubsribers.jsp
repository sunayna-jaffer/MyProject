...
<body>
<form method="Post" name="list" action="displayDailySubscribers.jsp" target="I1"><%
...
<table width="100%" border="0" cellspacing="1" cellpadding="0"
  ...
  <tr class="H1"> 
    <td colspan="4">HoujeratSubscription Daily subscribers</td>
  </tr>
  <tr class="content"> 
  ...
  <tr class="content">
    ...
    <td width="29%"><select name="Country">
    <option>Iraq</option>
      </select></td>
