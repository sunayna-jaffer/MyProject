...
<table width="90%" border="0" cellspacing="1" cellpadding="0"
	...
	Connection con=null;
   	...
   	ResultSet rs1=null;
   	String strKeywordType = "U";
	try{
		
		InitialContext context = new InitialContext();
	    ds = (DataSource)context.lookup("java:HoujeratSubscription");
		con = ds.getConnection();		
		pstmt1 = con.prepareStatement("SELECT keyword.id, keyword.keyword,  keyword.cid, contest.contestname FROM  keyword , Contest WHERE type IN ('U') AND keyword.cid = contest.cid");
...
<table width="100%">
	<tr>
		...
		<td width="70%" align="left"><a class="sublinks" href="UnSubcribeKeyword.jsp">Refresh</a>
		</td>
